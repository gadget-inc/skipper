...
dev test -bench=BenchmarkName -benchmem -count=6 ./internal/pkg/... | tee tmp/benchmarks/name-before.txt

# After optimization, run again
dev test -bench=BenchmarkName -benchmem -count=6 ./internal/pkg/... | tee tmp/benchmarks/name-after.txt
