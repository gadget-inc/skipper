...
const (
	...
	ControllerService_ReplaceInstance_FullMethodName = "/skipper.ControllerService/ReplaceInstance"
)
...
type ControllerServiceClient interface {
	...
	ReplaceInstance(ctx context.Context, in *ReplaceInstanceRequest, opts ...grpc.CallOption) (*ReplaceInstanceResponse, error)
}
...
func (c *controllerServiceClient) ReplaceInstance(ctx context.Context, in *ReplaceInstanceRequest, opts ...grpc.CallOption) (*ReplaceInstanceResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ReplaceInstanceResponse)
	err := c.cc.Invoke(ctx, ControllerService_ReplaceInstance_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ControllerServiceServer interface {
	...
	ReplaceInstance(context.Context, *ReplaceInstanceRequest) (*ReplaceInstanceResponse, error)
...
func (UnimplementedControllerServiceServer) ReplaceInstance(context.Context, *ReplaceInstanceRequest) (*ReplaceInstanceResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ReplaceInstance not implemented")
}
...
func _ControllerService_ReplaceInstance_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReplaceInstanceRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ControllerServiceServer).ReplaceInstance(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ControllerService_ReplaceInstance_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ControllerServiceServer).ReplaceInstance(ctx, req.(*ReplaceInstanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ControllerService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReplaceInstance",
			Handler:    _ControllerService_ReplaceInstance_Handler,
		},
	},
