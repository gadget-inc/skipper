...
const file_controller_proto_rawDesc = "" +
	...
	"\rScaleResponse\x12/\n" +
	"\tinstances\x18\x01 \x03(\v2\x11.skipper.InstanceR\tinstances\"\x18\n" +
	"\x16GetClusterStateRequest\"U\n" +
	"\x17GetClusterStateResponse\x12:\n" +
	"\rcluster_state\x18\x01 \x01(\v2\x15.skipper.ClusterStateR\fclusterState2\xaf\x02\n" +
...
var file_controller_proto_goTypes = []any{
	...
	(*GetClusterStateRequest)(nil),  // 6: skipper.GetClusterStateRequest
	(*GetClusterStateResponse)(nil), // 7: skipper.GetClusterStateResponse
	...
	(*ClusterState)(nil),            // 12: skipper.ClusterState
}
var file_controller_proto_depIdxs = []int32{
	...
	12, // 6: skipper.GetClusterStateResponse.cluster_state:type_name -> skipper.ClusterState
	...
	6,  // 10: skipper.ControllerService.GetClusterState:input_type -> skipper.GetClusterStateRequest
	...
	7,  // 14: skipper.ControllerService.GetClusterState:output_type -> skipper.GetClusterStateResponse
