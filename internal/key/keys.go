...
var (
	...
	ScaleTargetCPUMillicores    = uint32Key("scale_target_cpu_millicores")
	ScaleTargetInFlightRequests = uint32Key("scale_target_in_flight_requests")
	ScaleTargetMemoryMebibytes  = uint32Key("scale_target_memory_mebibytes")
