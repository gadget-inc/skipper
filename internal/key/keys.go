...
var (
	...
	CPUUsageMilli             = intKey("cpu_usage_milli")
	Controller                = newIdentifier("controller")
	Count                     = intKey("count")
	Deployment                = stringKey("deployment")
	DesiredInstances          = intKey("desired_instances")
	...
	InFlightRequests          = intKey("in_flight_requests")
	Instance                  = logValuerKey("instance")
	K8sReplicaSet             = replicaSetKey("k8s.replicaset")
	Labels                    = mapStringStringKey("labels")
	MaxInstances              = intKey("max_instances")
	MemoryUsageMiB            = intKey("memory_usage_mib")
	Metadata                  = stringKey("metadata")
	MinInstances              = intKey("min_instances")
	Name                      = stringKey("name")
	...
	TargetCPUUsageMilli       = intKey("target_cpu_usage_milli")
	TargetInFlightRequests    = intKey("target_in_flight_requests")
	TargetMemoryUsageMiB      = intKey("target_memory_usage_mib")
	Tenant                    = stringKey("tenant")
	Timestamp                 = timeKey("timestamp")
	Token                     = newIdentifier("token")
	URL                       = urlKey("url")
	UnclampedDesiredInstances = intKey("unclamped_desired_instances")
