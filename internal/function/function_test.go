...
func TestHashNoCollisions(t *testing.T) {
	...
	f1 := Function{Namespace: "ab", Deployment: "cd", Tenant: "", Metadata: ""}
	f2 := Function{Namespace: "abc", Deployment: "d", Tenant: "", Metadata: ""}
	f3 := Function{Namespace: "a", Deployment: "bcd", Tenant: "", Metadata: ""}
	f4 := Function{Namespace: "abcd", Deployment: "", Tenant: "", Metadata: ""}
	...
	f5 := Function{Namespace: "ns", Deployment: "dep", Tenant: "ab", Metadata: "cd"}
	f6 := Function{Namespace: "ns", Deployment: "dep", Tenant: "abc", Metadata: "d"}
	assert.Assert(t, f5.Hash() != f6.Hash(), "f5 and f6 should have different hashes")

	// Identical functions should have identical hashes
	f7 := Function{Namespace: "ns", Deployment: "dep", Tenant: "tenant", Metadata: "meta"}
	f8 := Function{Namespace: "ns", Deployment: "dep", Tenant: "tenant", Metadata: "meta"}
